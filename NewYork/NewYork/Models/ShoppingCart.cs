...
namespace NewYork.Models
{
    ...
    public class ShoppingCart
    {
        ...
        public ShoppingCart(DBContext db)
        {
            _db = db;
        }
        ...
        public static ShoppingCart GetCart(DBContext db, HttpContextBase context)
        {
        ...
        public static ShoppingCart GetCart(DBContext db, Controller controller)
        {
            return GetCart(db, controller.HttpContext);
        }

        public void AddToCart(Show show)
        {
            // Get the matching cart and album instances
            var cartItem = _db.Carts.SingleOrDefault(
                c => c.CartId == ShoppingCartId
                && c.ShowId == show.ShowId);
        ...
        public decimal GetTotal()
        {
            ...
            decimal? total = (from cartItems in _db.Carts
                              where cartItems.CartId == ShoppingCartId
                              select (int?)cartItems.Count * cartItems.show.Price).Sum();
        ...
        public int CreateOrder(Order order)
        {
            ...
            {
                var album = _db.Shows.Find(item.ShowId);
                ...
                orderTotal += (item.Count * item.show.Price);
